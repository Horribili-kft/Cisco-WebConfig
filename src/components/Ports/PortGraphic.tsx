...
function PortGraphic({ name = "Unknown interface", type = '', up = false }) {
    return (
        <div className="card bg-base-200 m-1 w-[4.5rem] shadow-2xl  hover:cursor-pointer hover:brightness-110 active:scale-95 transition-all duration-75">
            <figure>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} className={getUpStyle(up)}>
